...
<html lang="id">
    ...
    <body style="background-image:url(http://localhost/arsip/ardis/assets/img/bgd.jpeg);background-size:cover;>
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?=site_url()?>">Unisbank Semarang</a>
                </div>
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="np"><a class="btn btn-warning" data-toggle="modal" href="../index.php">Kembali</a></li>
                        <li class="np"><a class="btn btn-primary" data-toggle="modal" href="#modal-login">Masuk</a></li>
                    </ul>
                </div>
            </div>
        </nav>
