...
<footer class="footer">
    <div class="container">
        <p>&copy; <a href="https://www.unisbank.ac.id/" target="_blank">Unisbank Semarang</a> 
    </div>
</footer>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#search").keyup(function() {
            var str =  $("#search").val();
            if (str == "") {
                $("#hint" ).html("<p class='help-block'>Masukkan NIM / nama / tanggal lahir dan hasil akan otomatis ditampilkan disini.<br><small>Contoh format tanggal lahir 1998-11-20.</small></p>");
            } else {
