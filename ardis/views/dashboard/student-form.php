...
<hr>
    <div class="form-group">
        ...
        <div class="col-sm-4">
            <input type="text" name="s_nisn" class="form-control" value="<?=isset($student['s_nisn']) ? $student['s_nisn'] : set_value('s_nisn')?>" placeholder="NIM" required>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <select required name="s_grade" class="form-control">
                ...
                <option value="Bahasa & ilmu budaya">FBIB</option>
    ...
    <hr>
    <h3>Lampiran</h3>
    <p class="help-block">Format file yang diperbolehkan *.pdf dan ukuran maksimal 5 MB.</p>
    <hr>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Foto 3x4 </label>
        <div class="col-sm-10">
            <?php if ($this->uri->segment(2) == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Laporan Sah</label>
        <div class="col-sm-10">
            <?php if ($this->uri->segment(2) == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Tugas Akhir/Skripsi</label>
        <div class="col-sm-10">
            <?php if ($this->uri->segment(2) == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">Naskah Publikasi</label>
        <div class="col-sm-10">
            <?php if ($this->uri->segment(2) == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-sm-2 control-label">FC Lembar pembimbing</label>
        <div class="col-sm-10">
            <?php if ($this->uri->segment(2) == 'edit') { ?>
