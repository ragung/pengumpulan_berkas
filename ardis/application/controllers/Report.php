...
class Report extends CI_Controller {
    ...
    public function index()
    {
        ...
        if ($_GET) {
            ...
            $data['title'] = "Rekap Laporan &minus; Pengumpulan Berkas Skripsi Unisbank Semarang";
    ...
    private function validation()
    {
        ...
        $this->form_validation->set_rules('s_grade', 'Fakultas', 'trim|required');
        $this->form_validation->set_rules('m_initial', 'Progdi', 'trim|required');
